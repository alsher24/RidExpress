    ...
    <span><i class="bi bi-house-fill"></i></span>
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="notes-tab" data-bs-toggle="tab" data-bs-target="#notes" type="button"
                    ...
                    <a href="booking_status.php"><span><i class="bi bi-journal-album"></i></span></a>
                </button>
            </li>
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="project-tab" data-bs-toggle="tab" data-bs-target="#project" type="button"
                    ...
                    <a href="completed_bookings.php"><span><i class="bi bi-clipboard-check"></i></span></a>
                </button>

                <li class="nav-item" role="presentation">
    <a class="nav-link" href="rent_vehicle.php" role="tab" id="collection-tab" aria-controls="notif" aria-selected="false">
